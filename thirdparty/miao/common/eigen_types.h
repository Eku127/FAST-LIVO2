//
// Eigen and Sophus type definitions for MIAO optimizer
// Based on lightning-lm's eigen_types.h
//

#ifndef MIAO_EIGEN_TYPES_H
#define MIAO_EIGEN_TYPES_H
